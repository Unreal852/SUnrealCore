...
{
    @Override
    public Integer readValue(Class<Integer> tClass, CustomFileConfig config, String path)
    {
        return config.getInteger(path);
    }

    @Override
    public void writeValue(Class<Integer> tClass, CustomFileConfig config, String path, Integer value)
    {
