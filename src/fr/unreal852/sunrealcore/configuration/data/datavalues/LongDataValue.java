...
{
    @Override
    public Long readValue(Class<Long> tClass, CustomFileConfig config, String path)
    {
        return config.getLong(path);
    }

    @Override
    public void writeValue(Class<Long> tClass, CustomFileConfig config, String path, Long value)
    {
